...
class TestModelMixin(TestCase):
    ...
    def setUp(self):
        """Instantiate a AppUserModel before each test"""
        self.u = AppUserModel('test_u', 'test_p', 'test_u@test_o.com',
                              1, True, True, True)

    def test_iter(self):
        """Test the __iter__ method of the ModelMixin class."""
        u_list = [
            ('username', 'test_u'),
    ...
    def test_repr(self):
        """Test the __repr__ method of the ModelMixin class."""
        u_repr = f"<AppUserModel('username'='test_u', 'password_hash'='{self.u.password_hash}', 'email'='test_u@test_o.com', 'organization_id'=1, 'is_super'=True, 'is_owner'=True, 'is_active'=True)>"
    ...
    def test_to_dict(self):
        """Test the __to_dict__ method of the ModelMixin class."""
        u_dict = {
            'username': 'test_u',
            'password_hash': self.u.password_hash,
            'email': 'test_u@test_o.com',
